...
async def run_test():
    ...
    try:
        ...
        # Click the Login button to initiate login process
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Duplicate DBA name error: This DBA name already exists').first).to_be_visible(timeout=30000)
        except AssertionError:
            raise AssertionError('Test case failed: The system did not reject the creation of a bank with a duplicate DBA name as expected.')
