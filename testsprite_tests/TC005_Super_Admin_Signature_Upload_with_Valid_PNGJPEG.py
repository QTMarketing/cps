...
async def run_test():
    ...
    try:
        ...
        # -> Click the Login button to start login as Super Admin.
        ...
        # -> Input username and password for Super Admin and click Sign In.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Click Sign In button to log in as Super Admin
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Digital Signature Upload Successful').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError('Test case failed: Super Admin could not upload and assign digital signatures to banks as per the test plan.')
