...
async def run_test():
    ...
    try:
        ...
        # -> Click the Login button to proceed to login as Super Admin.
        ...
        frame = context.pages[-1]
        # Input username for Super Admin
        ...
        try:
            ...
            raise AssertionError('Test failed: Signature upload rejection for invalid file types (non-PNG/JPEG) did not occur as expected.')
