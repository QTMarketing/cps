...
async def run_test():
    ...
    try:
        ...
        # -> Log in with proper credentials to gain access to the Add User page.
        frame = context.pages[-1]
        # Click Login button to initiate login process
        ...
        try:
            ...
            raise AssertionError('Test case failed: The user creation form did not enforce mandatory fields and allowed submission with incomplete data, violating the test plan requirements.')
